        ...
        <div class="col-12 d-flex justify-content-center ">
            <div class="position-relative">
                <form action="{{route('editProfilePicture')}}" method="post" enctype="multipart/form-data" id="profilePictureForm">
                    @csrf
                    <img class="profilePicture my-3 " src="{{$user->profilePicture ? asset('assets/profile_pictures/' . $user->profilePicture) : 'https://via.placeholder.com/100'}}" alt="Profile Picture">
        ...
        <form class="row" action="{{route('edit-admin-profile',['adminId'=>$user->ic])}}" method="post">
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <input type="text" value="{{$user->name}}" name="profileName" class="form-control" id="">
                </div>
            </div>
            <div class="col-6">
                <div class="mb-3">
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-2"> <!-- Adjust column size as needed -->
                            <div class="border p-2 rounded">
                                <h5 class="mb-1">{{ $subject->subjectCode }}</h5> <!-- Subject code -->
                                <p class="mb-0">{{ $subject->subjectName }}</p> <!-- Subject name, if available -->
                            </div>
                        </div>
                        @endforeach
                    </div>
